...
import { FaChartPie, FaUsers, FaFileExcel, FaComments, FaSignOutAlt, FaBook, FaCog, FaCalendarAlt, FaCamera, FaExclamationCircle, FaClipboardList } from "react-icons/fa";
...
import Complaints from "./teacher/Complaints";
...
function TeacherDashboard() {
    ...
    const menuItems = [
        ...
        { id: "marks", name: "Marks Upload", icon: FaClipboardList, path: "/teacher-dashboard/marks" },
        ...
        { id: "complaints", name: "Complaints", icon: FaExclamationCircle, path: "/teacher-dashboard/complaints" },
