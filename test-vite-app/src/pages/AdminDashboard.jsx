...
import { FaUsersCog, FaChartLine, FaCog, FaSignOutAlt, FaBook, FaCalendarAlt, FaBell } from "react-icons/fa";
...
function AdminDashboard() {
    ...
    const menuItems = [
        ...
        { id: "complaints", name: "Complaints", icon: FaBell, path: "/admin-dashboard/complaints" },
