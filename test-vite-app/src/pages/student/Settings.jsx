 ...
 * Allows students to manage their profile and account settings
 */
            ...
            {showDeleteModal && (
                <div className="modal-overlay" onClick={() => setShowDeleteModal(false)}>
                    <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="warning-text">All your data, attendance records, and assignments will be permanently removed.</p>
