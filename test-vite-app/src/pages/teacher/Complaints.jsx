/**
 * Teacher Complaints Component
 * Allows teachers to submit complaints and track their status
 */
...
const CATEGORIES = ["Academic", "Technical", "Behavioural", "Infrastructure", "Administrative", "Other"];
    ...
    return (
        <div className="complaints-container">
            <div className="complaints-header">
                ...
                <div>
                    <h1>Complaints</h1>
                    <p>Submit a complaint to the administration and track its resolution</p>
                </div>
            </div>
